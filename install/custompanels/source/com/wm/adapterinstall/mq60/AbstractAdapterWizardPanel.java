...
import com.wm.distman.install.GenericInstallerWizardPanel;
import com.wm.distman.install.DebugLog;
import com.wm.distman.install.DistManUtils;
import com.wm.distman.helpers.*;
/**
 * <p>Title: AbstractAdapterWizardPanel</p>
 * <p>Description: Parent class for Adapter Wizard Panels</p>
 * <p>Copyright: Copyright (c) 1996-2003, webMethods Inc.  All Rights Reserved.</p>
 * @author Peter Fish
 * @version 1.0
 */

abstract public class AbstractAdapterWizardPanel extends GenericInstallerWizardPanel {
	...
	public AbstractAdapterWizardPanel()
	{
    }

	//Install Methods
	/**
	* Called in either console or GUI mode after installSetupConsole() or installSetupGUI()
	* - can be overridden.
	*/
    ...
    */
	...
	/**
	* When the user clicks 'next' this method is called.  Return true to go to the
	* next panel, false to stay on the current panel.  In console mode, returning
	* false from this method will cause installExecute() to be called again.
	*<B>Override this method </B>
	*<P>
	*/
	abstract public boolean installOkToContinue();
	/**
	* Called after installInit() to perform install console dialog.
	*<B>Override this method </B>
	*<P>
	*/
	abstract public boolean installSetupConsole();
	/**
	* Called after installInit() to set up install GUI panel.
	*<B>Override this method </B>
	*<P>
	*/
    abstract public boolean installSetupGUI();
	/**
	* Called in either console or GUI mode after uninstallSetupConsole() or uninstallSetupGUI()
	* - can be overridden.
	*/
    ...
    */
	protected boolean uninstallInit(String packageName)
	{
		installDir = installerAccess.getInstallDir() + File.separator + AdapterUtils.getProductName();
		packageDir = installDir + File.separator + "packages" + File.separator + packageName;
		uninstallObjectFileName = installDir + File.separator + "packages" + File.separator + packageName + File.separator + "uninstallObject";
		jarsDir = packageDir + File.separator + "code" + File.separator + "jars";
		if ( DistManUtils.isWindows() ) {
            // A JVM is bundled with the Windows install.
             javaHomeExecutable = installDir + File.separator + "jvm" + File.separator + "bin" + File.separator + "java.exe";
	...
	* When the user clicks 'next' this method is called.  Return true to go to the
	* next panel, false to stay on the current panel.  In console mode, returning
	* false from this method will cause uninstallExecute() to be called again.
	*<B>Override this method </B>
	*<P>
	*/
	abstract public boolean uninstallOkToContinue();
	/**
	* Called after installInit() to perform install console dialog.
	*<B>Override this method </B>
	*<P>
	*/
	abstract public boolean uninstallSetupConsole();
	/**
	* Called after installInit() to set up install GUI panel.
	*<B>Override this method </B>
	*<P>
	*/
    abstract public boolean uninstallSetupGUI();
